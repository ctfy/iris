...
public class AiManager implements ITalk {
    ...
    private List<BaseAi> talks = new ArrayList<BaseAi>();
    ...
    private String[] selectedIndexStyle = new String[] { Pinyin.getPingYin("零"), Pinyin.getPingYin("一"), Pinyin.getPingYin("二"), Pinyin.getPingYin("三"), Pinyin.getPingYin("四"), Pinyin.getPingYin("五"), Pinyin.getPingYin("六"), Pinyin.getPingYin("七"), Pinyin.getPingYin("八"), Pinyin.getPingYin("九"), Pinyin.getPingYin("十"), };
    ...
    public IAiCallback getAiCallback(Class cls) {
        for (ITalk tk : talks) {
            if (cls == tk.getClass()) {
                return (IAiCallback) tk;
            }
        }
        return null;
    }
